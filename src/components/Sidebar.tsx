     ...
     src="/img.jpeg"
      ...
      className=" mx-auto  border rounded-full "
       ...
       <h3 className="my-4 text-3xl font-medium tracking-wider font-Kaushan">
        <span className="text-green  ">Omnia Rafat</span> 
      </h3>
      <p className="px-2 py-1 my-3   b rounded-full 
          bg-gray-400 dark:bg-dark-200 dark:bg-black-500   ">
        Web Developer
      </p>
      {/* Resume */}
      <a
        ...
        className="flex items-center justify-center px-2 py-1 my-2 bg-gray-400 rounded-full cursor-pointer 
        dark:bg-dark-200 dark:bg-black-500 "
      >
      ...
      {/* Contacts */}
      <div
        className="py-4 my-5 bg-gray-400 rounded-md "
